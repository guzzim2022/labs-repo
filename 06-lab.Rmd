...
query_ids <- GET(
  ...
  query = list(db="pubmed", term="h5n1 toronto", retmax =1000)
)
...
publications <- GET(
  ...
  query = list(db="pubmed", rettype="abstract", retmax =1000, id = I(paste(ids, collapse = ",")))
)
...
institution <- str_extract_all(
  publications_txt,"University\\sof\\s[A-Za-z\\s]+|[A-Za-z]+\\sInstitute\\sof\\s[A-Za-z]+\\s")
...
schools_and_deps <- str_extract_all(
  publications_txt,
  "(School of [A-Za-z\\s]+|Department of [A-Za-z\\s]+)"
  )
...
sum(is.na(titles) | titles == "")
```

- How many of these don't have a title ? 

zero. all of them have titles. 
